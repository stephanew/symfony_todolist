...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\DataNew' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DataNew']) ? $this->services['AppBundle\Form\DataNew'] : $this->services['AppBundle\Form\DataNew'] = new \AppBundle\Form\DataNew()) && false ?: '_'};
}, 'AppBundle\\Form\\DataShow' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DataShow']) ? $this->services['AppBundle\Form\DataShow'] : $this->services['AppBundle\Form\DataShow'] = new \AppBundle\Form\DataShow()) && false ?: '_'};
}, 'AppBundle\\Form\\DataType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DataType']) ? $this->services['AppBundle\Form\DataType'] : $this->services['AppBundle\Form\DataType'] = new \AppBundle\Form\DataType()) && false ?: '_'};
}, 'AppBundle\\Form\\mailNew' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\mailNew']) ? $this->services['AppBundle\Form\mailNew'] : $this->services['AppBundle\Form\mailNew'] = new \AppBundle\Form\mailNew()) && false ?: '_'};
}, 'AppBundle\\Form\\mailShow' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\mailShow']) ? $this->services['AppBundle\Form\mailShow'] : $this->services['AppBundle\Form\mailShow'] = new \AppBundle\Form\mailShow()) && false ?: '_'};
}, 'AppBundle\\Form\\mailType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\mailType']) ? $this->services['AppBundle\Form\mailType'] : $this->services['AppBundle\Form\mailType'] = new \AppBundle\Form\mailType()) && false ?: '_'};
