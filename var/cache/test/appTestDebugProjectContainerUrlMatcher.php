...
class appTestDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // app_list_index
        if ('/list/index' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\ListController::indexAction',  '_route' => 'app_list_index',);
        }

        // app_list_mailer
        if ('/list/mail' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\ListController::mailerAction',  '_route' => 'app_list_mailer',);
        }
