...
";
    ...
    {
        return array (  124 => 44,  117 => 39,  104 => 32,  98 => 29,  92 => 26,  85 => 22,  81 => 21,  77 => 20,  71 => 19,  68 => 18,  64 => 17,  49 => 4,  40 => 3,  11 => 1,);
    }
...
{% block body %}
        ...
        {% for datum in datas %}
            <tr>
                ...
                <td>
                    <ul>
                        <li>
                            <a href=\"{{ path('data_show', { 'id': datum.id }) }}\">show</a>
                        </li>
                        <li>
                            <a href=\"{{ path('data_edit', { 'id': datum.id }) }}\">edit</a>
                        </li>
                        <li>
                            <a href=\"{{ path('mail_new', { 'content_id': datum.id }) }}\">set remind</a>
                        </li>
    ...
    <ul>
        <li>
            <a href=\"{{ path('data_new') }}\">Create a new datum</a>
        </li>
    </ul>
{% endblock %}
